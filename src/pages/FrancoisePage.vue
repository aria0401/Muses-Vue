...
export default {
    ...
    async created(){
        ...
        const paintings = data.filter(painting => painting.muse_name === 'francoise');
        this.paintings = paintings; 
        this.musePicture = paintings.shift();
        // get muse
        const res_muse = await axios.get('https://ariadna.dk/mios/WP/wp-json/wp/v2/muse/?include[]=201');
